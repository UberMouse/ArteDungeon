...
public class Equipable
{
    ...
    private static enum Equipment
    {
        ...
        CHAPS(Location.LEGS, ItemHandler.Style.MELEE, new int[]{Skills.DEFENSE, Skills.RANGE}, false, Type.ARMOUR),
        ROBE_BOTTOM(Location.LEGS,
                    ItemHandler.Style.MELEE,
    ...
    public Equipable(String itemName) {
        ...
        System.out.println(Equipment.toEnum(ItemHandler.getItemName(name)));
